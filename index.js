...
async function main() {
  ...
  manager.nlp.slotManager.addSlot('saw_heroes_eating', 'hero_1', true, {
    en: 'Who did you see?'
  });
  manager.nlp.slotManager.addSlot('saw_heroes_eating', 'hero_2', true, {
    en: 'With whom did you see {{ hero_1 }}?'
  });
  manager.nlp.slotManager.addSlot('saw_heroes_eating', 'food', true, {
